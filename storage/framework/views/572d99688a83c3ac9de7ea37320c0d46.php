...
<body class="bg-gradient-to-br from-slate-900 via-slate-800 to-indigo-900 min-h-screen text-slate-200 flex flex-col p-6">
    ...
    <nav class="glass rounded-xl px-6 py-4 mb-6 flex justify-between items-center max-w-7xl w-full mx-auto">
        ...
        <div class="flex gap-4 items-center">
            ...
            <a href="<?php echo e(route('indicadores.index')); ?>" class="px-4 py-2 text-sm font-medium text-slate-300 hover:text-white bg-slate-800/50 hover:bg-slate-700/50 rounded-lg transition-colors border border-slate-700/50">Indicadores</a>
...
<?php /**PATH /home/leticia/Documentos/sistema-ocorrencias/resources/views/consulta.blade.php ENDPATH**/ ?>