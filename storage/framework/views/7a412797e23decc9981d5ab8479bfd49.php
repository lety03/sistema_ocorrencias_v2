...
<body class="bg-gradient-to-br from-slate-900 via-slate-800 to-indigo-900 min-h-screen text-slate-200 flex flex-col p-6">
    ...
    <nav class="glass rounded-xl px-6 py-4 mb-6 flex justify-between items-center max-w-7xl w-full mx-auto" id="main-navbar">
        ...
        <div class="flex gap-4 items-center">
            ...
            <a href="<?php echo e(route('indicadores.index')); ?>" class="px-4 py-2 text-sm font-medium text-white bg-indigo-600/80 hover:bg-indigo-500/80 rounded-lg transition-colors border border-indigo-500/50 shadow-[0_0_15px_rgba(99,102,241,0.2)]">Indicadores</a>
            <?php if(auth()->user()->role === 'admin'): ?>
        ...
        <div class="glass rounded-2xl shadow-xl p-6" id="tipos-section">
            ...
            <div class="carousel-wrapper">
                ...
                <div class="carousel-track" id="tipos-container">
                    <?php $__currentLoopData = $tipos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $tipo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button class="tipo-card rounded-xl px-5 py-3.5 flex items-center gap-3 min-w-[180px] flex-shrink-0"
                            data-tipo="<?php echo e($tipo->tipo_ocorrencia); ?>" id="tipo-btn-<?php echo e($index); ?>"
                            onclick="selecionarTipo(this, '<?php echo e(addslashes($tipo->tipo_ocorrencia)); ?>')">
                            <span class="tipo-badge pos-default"><?php echo e($index + 1); ?></span>
                            <div class="text-left">
                                <div class="text-sm font-semibold text-white leading-tight"><?php echo e($tipo->tipo_ocorrencia); ?></div>
                                <div class="text-xs text-slate-400 mt-0.5"><?php echo e(number_format($tipo->total, 0, ',', '.')); ?> ocorrência<?php echo e($tipo->total != 1 ? 's' : ''); ?></div>
                            </div>
                        </button>
...
</html><?php /**PATH /home/leticia/Documentos/sistema-ocorrencias/resources/views/indicadores.blade.php ENDPATH**/ ?>