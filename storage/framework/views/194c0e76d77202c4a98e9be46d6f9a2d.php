...
<body class="bg-gradient-to-br from-slate-900 via-slate-800 to-indigo-900 min-h-screen text-slate-200 flex flex-col p-6">
    ...
    <!-- Navbar -->
    <nav class="glass rounded-xl px-6 py-4 mb-6 flex justify-between items-center max-w-7xl w-full mx-auto transition-all">
        ...
        <div class="flex gap-4 items-center">
            <a href="<?php echo e(route('upload.index')); ?>" class="px-4 py-2 text-sm font-medium text-white bg-indigo-600/80 hover:bg-indigo-500/80 rounded-lg transition-colors border border-indigo-500/50 shadow-[0_0_15px_rgba(99,102,241,0.2)]">Upload Planilha</a>
            
            <a href="<?php echo e(route('consulta.index')); ?>" class="px-4 py-2 text-sm font-medium text-slate-300 hover:text-white bg-slate-800/50 hover:bg-slate-700/50 rounded-lg transition-colors border border-slate-700/50">Consultar</a>
    ...
    <div class="flex flex-col items-center justify-center flex-1 w-full">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-slate-400 text-sm">Faça o upload da planilha Excel (.xls, .xlsx) para sincronizar os funcionários e ocorrências do ponto.</p>
        </div>

        <form id="uploadForm" class="space-y-6" action="<?php echo e(route('upload.store')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            
            <div class="relative group">
                <label for="arquivo" class="flex flex-col items-center justify-center w-full h-40 border-2 border-slate-600 border-dashed rounded-xl cursor-pointer bg-slate-800/50 hover:bg-slate-700/50 hover:border-indigo-500 transition-all duration-200 group-hover:shadow-[0_0_15px_rgba(99,102,241,0.2)]">
                    <div class="flex flex-col items-center justify-center pt-5 pb-6">
                        <svg class="w-8 h-8 mb-3 text-slate-400 group-hover:text-indigo-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                        </svg>
                        <p class="mb-1 text-sm text-slate-300"><span class="font-semibold">Clique para selecionar</span> ou arraste o arquivo</p>
            ...
            <button type="submit" id="submitBtn" class="w-full flex items-center justify-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 focus:ring-offset-slate-900 transition-colors disabled:opacity-50 disabled:cursor-not-allowed">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-green-200/80">
                            <ul class="list-disc pl-5 space-y-1">
                                <li>Funcionários processados: <span class="font-bold text-white" id="resFunc">0</span></li>
                                <li>Ocorrências registradas: <span class="font-bold text-white" id="resOcor">0</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<?php /**PATH C:\Users\OI417415.OI\Documents\SDOP\sistema-ocorrencias\resources\views/upload.blade.php ENDPATH**/ ?>