...
<body class="bg-gradient-to-br from-slate-900 via-slate-800 to-indigo-900 min-h-screen text-slate-200 flex flex-col p-6">
    ...
    <nav class="glass rounded-xl px-6 py-4 mb-6 flex justify-between items-center max-w-7xl w-full mx-auto transition-all">
        ...
        <div class="flex gap-4 items-center">
            <a href="{{ route('upload.index') }}" class="px-4 py-2 text-sm font-medium text-white bg-indigo-600/80 hover:bg-indigo-500/80 rounded-lg transition-colors border border-indigo-500/50 shadow-[0_0_15px_rgba(99,102,241,0.2)]">Upload Planilha</a>
    ...
    <div class="flex flex-col items-center justify-center flex-1 w-full">
        ...
        <form id="uploadForm" class="space-y-6" action="{{ route('upload.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
